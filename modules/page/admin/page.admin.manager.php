...
$perpage = (int)$cfg['maxrowsperpage'] * 2;
...
$currentpage = ceil($d / $perpage) + 1;
$pagination = sed_pagination(sed_url("admin", "m=page&s=manager" . "&c=" . $c . "&sm=" . $sm . "&wm=" . $wm), $d, $totallines, $perpage);
list($pageprev, $pagenext) = sed_pagination_pn(sed_url("admin", "m=page&s=manager" . "&c=" . $c . "&sm=" . $sm . "&wm=" . $wm), $d, $totallines, $perpage, TRUE);
