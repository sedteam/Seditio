...
[BEGIN_SED]
File=modules/polls/admin/polls.admin.php
Version=185
Updated=2026-feb-14
Type=Module.admin
Author=Seditio Team
...
$urlpaths[sed_url("admin", "m=polls")] =  $L['core_polls'];

$admintitle = $L['core_polls'];
...
if ($n == 'options') {
	...
	if (isset($db_forum_topics)) {
		...
		$sql = sed_sql_query("SELECT p.*, NULL as ft_id FROM $db_polls AS p
			WHERE 1 ORDER BY p.poll_type ASC, p.poll_id DESC LIMIT 20");
	}
