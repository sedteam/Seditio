...
Author=Seditio Team
Description=Forums
Hooks=forums.newtopic.first,forums.newtopic.newtopic.first,forums.newtopic.newtopic.done,forums.newtopic.main,forums.newtopic.tags
[END_SED]
==================== */
...
if ($a == 'newtopic') {
	...
	if ($poll && sed_module_active('polls')) {
		sed_poll_check();
	}
