...
[BEGIN_SED]
File=modules/forums/admin/forums.admin.structure.php
Version=185
Updated=2026-feb-14
Type=Module.admin
Author=Seditio Team
Description=Forums structure (categories)
[END_SED]
==================== */
...
if ($n == 'options') {
	...
	if ($a == 'update') {
		...
		sed_cache_clear('sed_forums_str');
		sed_redirect(sed_url("admin", "m=forums&s=structure", "", true), false, ['msg' => '301']);
		exit;
	} elseif ($a == 'delete') {
		sed_check_xg();
