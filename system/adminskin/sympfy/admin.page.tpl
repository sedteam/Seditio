...
<div class="title">
	<span><i class="ic-forums"></i></span><h2>{ADMIN_PAGE_TITLE}</h2>
</div>
		...
		<div class="tab-content" id="tab2">
			...
			<form id="addstructure" action="{PAGE_STRUCTURE_ADD_SEND}" method="post">
				...
				<ul class="form responsive-form">
					...
					<li class="form-row">
						<div class="form-label"><label>{PHP.L.Code} :</label></div>
						<div class="form-field">{PAGE_STRUCTURE_ADD_CODE} <div class="descr">{PHP.L.adm_required}</div></div>
					</li>
					
					<li class="form-row">
						<div class="form-label"><label>{PHP.L.Path} :</label></div>
						<div class="form-field">{PAGE_STRUCTURE_ADD_PATH} <div class="descr">{PHP.L.adm_required}</div></div>
					</li>
					
					<li class="form-row">
						<div class="form-label"><label>{PHP.L.Title} :</label></div>
						<div class="form-field">{PAGE_STRUCTURE_ADD_TITLE} <div class="descr">{PHP.L.adm_required}</div></div>
					</li>
