...
$L['install_error_db_connection'] = "Не удалось подключиться к базе данных. Проверьте хост, имя пользователя, пароль и имя базы.";
...
$L['install_plugin_skipped'] = "пропущен (требуемый модуль %s не установлен)";
...
$L['install_database_clear_before'] = "Очистить базу перед импортом :";
$L['install_database_clear_before_hint'] = "Удалить все таблицы в базе данных перед созданием новых.";
$L['install_database_cleared'] = "База очищена";
$L['install_tables_dropped'] = "таблиц удалено";
...
$L['install_fill_required'] = "Заполните все обязательные поля:";
