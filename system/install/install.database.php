...
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(1, 0, 'Menu', '', 1, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(2, 1, 'Home', '/', 2, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(3, 1, 'Forums', 'forums/', 3, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(4, 1, 'Articles', 'articles/', 4, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(5, 1, 'Galleries', 'gallery/', 5, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(6, 1, 'Contact', 'plug/contact', 6, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(7, 4, 'Sample category 1', 'articles/sample1/', 1, 1, '', '', '', 0, 0);");
$sql = sed_sql_query("INSERT INTO " . $cfg['mysqldb'] . "menu VALUES(8, 4, 'Sample category 2', 'articles/sample2/', 2, 1, '', '', '', 0, 0);");
