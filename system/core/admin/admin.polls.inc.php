...
$adminmain .= "<ul><li><a href=\"admin.php?m=config&amp;n=edit&amp;o=core&amp;p=polls\">".$L['Configuration']."</a></li></ul>";
...
if ($n=='options')
	...
	while ($row1 = sed_sql_fetchassoc($sql1))
		...
		$adminmain .= "<tr><td><a href=\"admin.php?m=polls&amp;n=options&amp;a=delete&amp;id=".$row1['po_pollid']."&amp;po=".$row1['po_id']."&amp;".sed_xg()."\">".$out['img_delete']."</a>";
	...
	while ($row = sed_sql_fetchassoc($sql))
		...
		$adminmain .= "<tr><td style=\"text-align:center;\"><a href=\"admin.php?m=polls&amp;a=delete&amp;id=".$id."&amp;".sed_xg()."\">".$out['img_delete']."</a></td>";
		...
		if ($type==0)
			{ $adminmain .= "<a href=\"polls.php?id=".$row['poll_id']."\"><img src=\"system/img/admin/jumpto.png\" alt=\"\"></a>"; }
		else
			{ $adminmain .= "<a href=\"forums.php?m=posts&amp;q=".$row['ft_id']."\"><img src=\"system/img/admin/jumpto.png\" alt=\"\"></a>"; }
