...
if ($a == 'update') {
	...
	sed_redirect(sed_url("admin", "m=smilies", "", true), false, ['msg' => '917']);
	exit;
} elseif ($a == 'add') {
	...
	sed_cache_clear('sed_smilies');
	sed_redirect(sed_url("admin", "m=smilies", "", true), false, ['msg' => '301']);
	exit;
} elseif ($a == 'delete') {
	sed_check_xg();
	...
	sed_cache_clear('sed_smilies');
	sed_redirect(sed_url("admin", "m=smilies", "", true), false, ['msg' => '302']);
	exit;
}
