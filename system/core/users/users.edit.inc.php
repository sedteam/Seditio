...
$useredit_form_extra9 = "<div><textarea name=\"ruserextra9\" rows=\"4\" cols=\"".$cfg['textarea_default_width']."\">".sed_cc($urr['user_extra9'], ENT_QUOTES)."</textarea><input type=\"hidden\" name=\"ruserextra9_p\" value=\"1\" /></div>";
...
$t->assign(array(
	...
	"USERS_EDIT_TEXT" => "<div><textarea name=\"rusertext\" rows=\"4\" cols=\"".$cfg['textarea_default_width']."\">".sed_cc($urr['user_text'], ENT_QUOTES)."</textarea></div>",
	"USERS_EDIT_TEXTBOXER" => "<div><textarea name=\"rusertext\" rows=\"4\" cols=\"".$cfg['textarea_default_width']."\">".sed_cc($urr['user_text'])."</textarea></div>",
