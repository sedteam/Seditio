...
$L['core_message'] = "Системные сообщения";
$L['core_admin'] = "Административная панель";
$L['core_log'] = "Журнал";
...
$L['adm_syscomponents'] = "Системные компоненты";  // New in v186
$L['adm_component_name'] = "Название компонента";  // New in v186
...
$L['adm_config_missing_title'] = "Опции из setup, которых нет в базе";
$L['adm_config_missing_descr'] = "Эти ключи есть в файле setup, но отсутствуют в базе (например после обновления движка). «Добавить» вставляет строку с значениями по умолчанию из setup.";
$L['adm_config_missing_action'] = "Действие";
$L['adm_config_missing_add'] = "Добавить";
...
$L['cfg_maxratsperpage'] = array("Рейтингов на страницу в админке", "");
...
$L['cfg_pfs_filemask'] = array("Метка времени при конфликте имён", "При загрузке файла с уже существующим именем добавлять метку времени (-1730000123) вместо порядкового номера (-2, -3).");  // New Sed 172
...
$L['cfg_th_logotrsp'] = array("Уровень прозрачности логотипа в %", "По умолчанию: 50");
$L['cfg_th_logojpegqual'] = array("Качество JPEG после вставки логотипа", "По умолчанию: 90");
...
$L['adm_menu_cssclass'] = "CSS класс";
$L['adm_menu_cat_none'] = "— только ручное подменю —";
$L['adm_menu_cat_source'] = "Категория-источник";
$L['adm_menu_cat_source_hint'] = "Необязательно. Если указана, пункты подменю формируются автоматически из этой категории страниц (см. флажки ниже). Сначала выводятся ручные дочерние пункты из БД, затем автоматические.";
$L['adm_menu_cat_subcats'] = "Включать подкатегории";
$L['adm_menu_cat_pages'] = "Включать страницы категории";
$L['adm_menu_cat_auto'] = "авто";
$L['adm_help_menu'] = "В админке \"Менеджер меню\" создайте пункты (Title), свяжите их с родителем (Parent), задайте URL, позицию и видимость (Visible).<br />Опционально: укажите категорию страниц как источник — подменю соберётся из её подкатегорий и/или страниц (нужен модуль Page).<br />В публичных шаблонах меню выводится из дерева sed_menu, где N — ID пункта-родителя (menu_pid):<br />- {PHP.sed_menu.N.childrens} — полное дерево дочерних пунктов (родитель не выводится)<br />- {PHP.sed_menu.N.childrensonlevel} — один уровень дочерних пунктов (родитель не выводится)<br />- {PHP.sed_menu.N.parent} — только родительский пункт.";
...
$L['adm_requires_modules'] = "Требует (модули)";
$L['adm_requires_plugins'] = "Требует (плагины)";
$L['adm_dependent_plugins'] = "Плагины, зависящие от этого модуля";
...
$L['adm_opt_installpart'] = "Установить часть";
$L['adm_opt_deletepart'] = "Удалить часть";
