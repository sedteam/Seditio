...
$L['adm_help_menu'] = "В админке \"Менеджер меню\" создайте пункты (Title), свяжите их с родителем (Parent), задайте URL, позицию и видимость (Visible).<br />В публичных шаблонах меню выводится из дерева sed_menu, где N — ID пункта-родителя (menu_pid):<br />- {PHP.sed_menu.N.childrens} — полное дерево дочерних пунктов (родитель не выводится)<br />- {PHP.sed_menu.N.childrensonlevel} — один уровень дочерних пунктов (родитель не выводится)<br />- {PHP.sed_menu.N.parent} — только родительский пункт.";
