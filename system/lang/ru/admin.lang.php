...
$L['adm_help_config_rss'] = "Ссылки для вызова RSS лент:<br />rss.php (по-умолчанию, выводятся новости из категории указанной в настройках)<br />rss.php?m=pages&c=XX (XX - код категории, последние страницы из категории)<br />rss.php?m=comments&id=XX (XX - ID страницы, комментарии к странице)<br />rss.php?m=forums (последние посты из всех секций форума)<br />rss.php?m=forums&s=XX (XX - ID секции, последние посты в секции)<br />rss.php?m=forums&q=XX (XX - ID топика, последние посты в топике)<br />rss.php?m=forums&s=XX&q=YY(XX - ID секции, YY - ID топика)";
