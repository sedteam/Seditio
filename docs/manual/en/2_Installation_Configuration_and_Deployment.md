...
* After successful installation of selected plugins, the final SEF URL cache is generated (`sed_urls_generate()`, which is also automatically regenerated by the core if ever removed) and basic site statistics are initialized.
