...
$systemfiles['core'][] = 'modules/users/admin/users.admin.php';
$systemfiles['core'][] = 'modules/users/admin/users.admin.menu.php';
...
$systemfiles['core'][] = 'modules/page/page.php';
$systemfiles['core'][] = 'modules/page/page.add.php';
$systemfiles['core'][] = 'modules/page/page.edit.php';
$systemfiles['core'][] = 'modules/page/page.list.php';
$systemfiles['core'][] = 'modules/page/page.main.php';
$systemfiles['core'][] = 'modules/pfs/pfs.php';
$systemfiles['core'][] = 'modules/pfs/pfs.main.php';
$systemfiles['core'][] = 'modules/pfs/pfs.view.php';
$systemfiles['core'][] = 'modules/pfs/pfs.edit.php';
$systemfiles['core'][] = 'modules/pfs/pfs.editfolder.php';
$systemfiles['core'][] = 'system/core/plug/plug.inc.php';
$systemfiles['core'][] = 'system/core/plug/plug.php';
$systemfiles['core'][] = 'modules/pm/pm.php';
$systemfiles['core'][] = 'modules/pm/pm.main.php';
$systemfiles['core'][] = 'modules/pm/pm.send.php';
$systemfiles['core'][] = 'modules/pm/pm.edit.php';
$systemfiles['core'][] = 'modules/pm/admin/pm.admin.php';
$systemfiles['core'][] = 'system/core/resizer/resizer.php';
$systemfiles['core'][] = 'modules/polls/polls.main.php';
$systemfiles['core'][] = 'modules/polls/polls.php';
$systemfiles['core'][] = 'modules/polls/inc/polls.functions.php';
$systemfiles['core'][] = 'modules/polls/admin/polls.admin.php';
$systemfiles['core'][] = 'modules/rss/rss.main.php';
$systemfiles['core'][] = 'modules/rss/rss.php';
$systemfiles['core'][] = 'modules/sitemap/sitemap.main.php';
$systemfiles['core'][] = 'modules/sitemap/sitemap.php';
$systemfiles['core'][] = 'modules/view/view.main.php';
$systemfiles['core'][] = 'modules/view/view.php';
$systemfiles['core'][] = 'modules/users/users.auth.php';
$systemfiles['core'][] = 'modules/users/users.details.php';
$systemfiles['core'][] = 'modules/users/users.edit.php';
$systemfiles['core'][] = 'modules/users/users.main.php';
$systemfiles['core'][] = 'modules/users/users.logout.php';
$systemfiles['core'][] = 'modules/users/users.profile.php';
$systemfiles['core'][] = 'modules/users/users.register.php';
$systemfiles['core'][] = 'modules/users/users.php';
$systemfiles['core'][] = 'modules/users/users.setup.php';
$systemfiles['core'][] = 'modules/users/inc/users.functions.php';
$systemfiles['core'][] = 'modules/users/users.urls.php';
