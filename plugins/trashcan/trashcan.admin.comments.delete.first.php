...
[BEGIN_SED]
File=plugins/trashcan/trashcan.admin.comments.delete.first.php
Version=185
Updated=2026-mar-26
Type=Plugin
[END_SED]
...
[BEGIN_SED_EXTPLUGIN]
Code=trashcan
Part=admin.comments.delete.first
Hooks=admin.comments.delete.first
File=trashcan.admin.comments.delete.first
Order=1
Lock=0
[END_SED_EXTPLUGIN]
