...
Code=textboxer2
Part=comments
File=tb2.comments.edit
Hooks=comments.editcomment.tags
Tags=comments.tpl:{COMMENTS_EDIT_FORM_TEXTBOXER}
Order=10
[END_SED_EXTPLUGIN]
...
$t->assign("COMMENTS_EDIT_FORM_TEXT", $ta);
$t->assign("COMMENTS_EDIT_FORM_TEXTBOXER", $ta);
