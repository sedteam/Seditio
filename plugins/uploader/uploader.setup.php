...
use_sortable=03:select:yes,no:no:If set to yes, the sorting setting will be enabled.
use_dragndrop=04:select:yes,no:no:If set to yes, the Drag & Drop setting will be enabled.
use_rotation=05:select:yes,no:no:If set to yes, the image rotation setting will be enabled.
