...
$L['plu_explain4'] = "Если в профиле отсутствует e-mail, или указан недействующий адрес то восстановить пароль неполучится. <br />В этом случае <a href=\"plug.php?e=contact\">обратись к владельцам сайта</a>.";
...
$L['plu_loggedin3'] = "Теперь зайди в <a href='users.php?m=profile'>профиль</a> и установи новый пароль.";
