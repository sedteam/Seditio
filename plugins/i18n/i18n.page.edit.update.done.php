...
[BEGIN_SED]
File=plugins/i18n/i18n.page.edit.update.done.php
Version=185
Type=Plugin
[END_SED]
...
[BEGIN_SED_EXTPLUGIN]
Code=i18n
Part=page.edit.update.done
File=i18n.page.edit.update.done
...
if ($page_id > 0 && !empty($i18n_langs) && is_array($i18n_langs)) {
	...
	foreach ($i18n_langs as $lang) {
		...
		$post_key = 'rpage_i18n_' . $lang_lower;
	...
	if (!empty($data)) {
		i18n_save_page_translations($page_id, $data);
	}
}
