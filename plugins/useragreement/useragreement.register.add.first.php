...
[BEGIN_SED]
File=plugins/useragreement/useragreement.register.add.first.php
Version=1.0.0
Updated=2026-jul-13
Type=Plugin
Author=Seditio Team
Description=Validates user agreement checkbox during user registration.
[END_SED]

[BEGIN_SED_EXTPLUGIN]
Code=useragreement
Part=validation
File=useragreement.register.add.first
