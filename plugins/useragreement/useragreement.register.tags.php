...
[BEGIN_SED]
File=plugins/useragreement/useragreement.register.tags.php
Version=1.0.0
Updated=2026-jul-13
Type=Plugin
Author=Seditio Team
...
Code=useragreement
Part=register
File=useragreement.register.tags
Hooks=users.register.tags
Tags=users.register.tpl:{USERS_REGISTER_AGREEMENT}
Order=10
Lock=0
[END_SED_EXTPLUGIN]
...
if ($mask > 0) {
	...
	$t->assign("USERS_REGISTER_AGREEMENT", $agreement_html);
