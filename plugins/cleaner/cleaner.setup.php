...
userprune=02:select:0,1,2,3,4,5,6,7:2:Delete the user accounts not activated within * days (0 to disable).
logprune=03:select:0,1,2,3,7,15,30,60:15:Delete the log entries older than * days (0 to disable).
